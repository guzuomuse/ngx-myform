...
Once you have installed your library, you can import your library in any Angular application:
...
...
 ...
  const models = [
  ...
  ngOnInit(){
    this.fg=this.fs.createFormGroup(config);
  }
...
}
```
...
```html
<form [formGroup]='fg'>
  <ngx-bootstrap-control *ngFor="let model of models" [model]='model' [fg]='fg'>
