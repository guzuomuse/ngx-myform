import { Component, Directive, ElementRef, EventEmitter, Injectable, Input, NgModule, Output, Pipe, Renderer2 } from '@angular/core';
    ...
    FormService.prototype.createFormGroup = function (group, groupExtra) {
        ...
        try {
            group.forEach(function (model) {
                ...
                if (model.type === 'group') {
                    groupExtra = {
                        validator: Validators.compose(_this.getValidators(item.validators)),
                        asyncValidator: Validators.composeAsync(_this.getValidators(item.asyncValidators)),
                    };
                    ...
                    }, Validators.compose(_this.getValidators(item.validators)), Validators.composeAsync(_this.getValidators(item.asyncValidators)));
                }
            });
...
ModelAttributesDirective.decorators = [
    { type: Directive, args: [{ selector: '[modelAttributes]' },] },
];
/**
 * @nocollapse
 */
...
ModelAttributesDirective.propDecorators = {
    'modelAttributes': [{ type: Input },],
    'defaultClasses': [{ type: Input },],
};
...
ModelEventsDirective.decorators = [
    { type: Directive, args: [{ selector: '[modelEvents]' },] },
];
/**
 * @nocollapse
 */
...
export { NgxMyFormModule, FormService, InputModel, GroupModel, TextareaModel, SelectModel, CheckboxModel, RadiogroupModel, ModelAttributesDirective, ModelEventsDirective, SanitizeHtmlPipe, NgxBootstrapControlComponent, NgxBootstrapFormComponent };
